# Bun Transcription Makefile
# Framework-agnostic commands for managing the project and git submodules

.PHONY: help check check-prereqs install init install-backend install-frontend build start start-backend start-frontend test update clean status eject-frontend

# Default target: show help
help:
	@echo "Bun Transcription - Available Commands"
	@echo "======================================="
	@echo ""
	@echo "Setup:"
	@echo "  make check-prereqs     Check for required tools (git, bun)"
