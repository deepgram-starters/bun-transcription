...
Bun demo app for Deepgram Transcription.
...
```
feat(bun-transcription): add diarization support
fix(bun-transcription): resolve WebSocket close handling
refactor(bun-transcription): simplify session endpoint
